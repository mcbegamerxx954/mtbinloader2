...
const RPMC_PATTERNS: [Pattern<80>; 9] = [
...
Pattern::from_str("FF C3 02 D1 FD 7B 05 A9 FB 33 00 F9 FA 67 07 A9 F8 5F 08 A9 F6 57 09 A9 F4 4F 0A A9 FD 43 01 91 5A D0 3B D5 F7 03 03 2A F6 03 02 AA 48 17 40 F9 F3 03 00 AA A8 83 1F F8"),//1.21.120.23
Pattern::from_str("FF 83 02 D1 FD 7B 04 A9 FB 2B 00 F9 FA 67 06 A9 F8 5F 07 A9 F6 57 08 A9 F4 4F 09 A9 FD 03 01 91 5A D0 3B D5 F6 03 03 2A F5 03 02 AA 48 17 40 F9 F3 03 00 AA A8 83 1F F8"),//1.21.120.04
Pattern::from_str("FF C3 02 D1 FD 7B 05 A9 FC 6F 06 A9 FA 67 07 A9 F8 5F 08 A9 F6 57 09 A9 F4 4F 0A A9 FD 43 01 91 5B D0 3B D5 F7 03 03 2A F6 03 02 AA 68 17 40 F9 F3 03 00 AA A8 83 1F F8"),//1.21.130.22-1.21.130.24
